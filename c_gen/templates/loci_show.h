...
#define LOCI_SHOW_str16(writer, cookie, val) LOCI_SHOW_string(writer, cookie, val)
#define LOCI_SHOW_str8(writer, cookie, val) LOCI_SHOW_string(writer, cookie, val)
#define LOCI_SHOW_str4(writer, cookie, val) LOCI_SHOW_string(writer, cookie, val)
