...
#define LOCI_SHOW_u32_image_checksum_hash(writer, cookie, val) LOCI_SHOW_u32(writer, cookie, val)
#define LOCI_SHOW_u32_startup_config_hash(writer, cookie, val) LOCI_SHOW_u32(writer, cookie, val)
