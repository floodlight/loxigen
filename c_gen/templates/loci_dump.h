...
#define LOCI_DUMP_str16(writer, cookie, val) LOCI_DUMP_string(writer, cookie, val)
#define LOCI_DUMP_str8(writer, cookie, val) LOCI_DUMP_string(writer, cookie, val)
#define LOCI_DUMP_str4(writer, cookie, val) LOCI_DUMP_string(writer, cookie, val)
...
#define LOCI_DUMP_u128(writer, cookie, val) writer(cookie, "%" PRIx64 "%" PRIx64, (val).hi, (val).lo)
