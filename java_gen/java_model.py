...
class JavaModel(object):
    ...
    def interfaces(self):
        interfaces = []
        for ir_interface in loxi_globals.unified.classes:
            ...
            if ir_interface.name.startswith("of_meter") or ir_interface.name.startswith("of_bucket")\
                ...
                continue
            if ir_interface.is_subclassof("of_oxm") and ir_interface.name in \
                ("of_oxm_bsn_vrf_masked", "of_oxm_bsn_global_vrf_allowed_masked",
                 "of_oxm_bsn_l3_dst_class_id_masked", "of_oxm_bsn_l3_interface_class_id_masked",
                 "of_oxm_bsn_l3_src_class_id_masked", "of_oxm_bsn_lag_id_masked",
                 "of_oxm_bsn_vrf_masked",
                 "of_oxm_bsn_vrf", "of_oxm_bsn_global_vrf_allowed",
                 "of_oxm_bsn_l3_dst_class_id", "of_oxm_bsn_l3_interface_class_id",
                 "of_oxm_bsn_l3_src_class_id", "of_oxm_bsn_lag_id",
                 "of_oxm_bsn_vrf"):
                continue
            interfaces.append(JavaOFInterface(ir_interface))
